...
public class Colosseum {
    ...
    public static Pokemon buildPokemon() {
        ...
        int adjustedDefense = MAX_HIT_POINTS - tempPokemon.attackLevel;
        System.out.println("Enter Defense Level");
        tempPokemon.defenseLevel = myScan.nextInt();
        while (tempPokemon.defenseLevel < 1 || tempPokemon.defenseLevel > adjustedDefense) {
            System.out.println("Sorry, defense level must be between 1 and " + adjustedDefense);
            tempPokemon.defenseLevel = myScan.nextInt();
        }
        return tempPokemon;
    }
     ...
     * Implement this function.
     */
    public static void printWhoIsAhead(Pokemon first, Pokemon second) {
     ...
     * Write this function.
     */
    public static void determineWinner(Pokemon first, Pokemon second) {
        if (first.hitPoints < 1) {
            System.out.println(second.name + " is the winner!");
        } else if (second.hitPoints < 1) {
            System.out.println(first.name + " is the winner!");
        }
    }
